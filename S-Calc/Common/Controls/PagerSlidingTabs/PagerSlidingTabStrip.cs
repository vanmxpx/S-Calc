...
namespace S_Calc.Common.Controls.PagerSlidingTabs
{
    ...
    public class PagerSlidingTabStrip : HorizontalScrollView, Android.Support.V4.View.ViewPager.IOnPageChangeListener, ViewTreeObserver.IOnGlobalLayoutListener
    {
        ...
        private bool separatorOnTop;
        /// <summary>
        /// Gets or sets the underline color
        /// </summary>
        public bool SeparatorOnTop
        {
            get { return separatorOnTop; }
            set
            {
                separatorOnTop = value;
                Invalidate();
            }
        }
        ...
        {
            TabTextColor = GetColorStateList(ContextCompat.GetColor(Context, resId));
        }

        public void SetTabTextColorListResource(int resId)
        {
            TabTextColor = ContextCompat.GetColorStateList(Context, resId);
        }
            ...
            : base(context, attrs, defStyle)
        {
            ...
            separatorHeight = (int)TypedValue.ApplyDimension(ComplexUnitType.Dip, separatorHeight, dm);
            ...
            separatorColor = textPrimaryColor;
            ...
            separatorColor = a.GetColor(Resource.Styleable.PagerSlidingTabStrip_pstsSeparatorColor, separatorColor);
            separatorOnTop = a.GetBoolean(Resource.Styleable.PagerSlidingTabStrip_pstsSeparatorOnTop, separatorOnTop);
            ...
            separatorHeight = a.GetDimensionPixelSize(Resource.Styleable.PagerSlidingTabStrip_pstsSeparatorHeight, separatorHeight);
        ...
        private void SetMarginBottomTabContainer()
        {
            ...
            var bottomMargin = indicatorHeight >= separatorHeight ? indicatorHeight : separatorHeight;
            if(separatorOnTop)
                mlp.SetMargins(mlp.LeftMargin, bottomMargin, mlp.RightMargin, mlp.BottomMargin);
            else
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            if(separatorOnTop)
                canvas.DrawRect(paddingLeft, 0, tabsContainer.Width + paddingRight, separatorHeight, rectPaint);
            else
                canvas.DrawRect(paddingLeft, height - separatorHeight, tabsContainer.Width + paddingRight, height, rectPaint);
